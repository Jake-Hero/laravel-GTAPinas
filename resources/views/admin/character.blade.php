...
<!-- Container -->
    ...
    <div class="row mb-5">
        ...
        <div class="col">
            <a href="{{ route('admin.characters') }}" class="btn btn-dark"><i class="fas fa-arrow-left"></i> Characters List</a>
        </div>
    </div>
                ...
                <!-- Initiate container -->
                    ...
                    <!-- Initialize row -->
                        ...
                        <div class="col-xs-12 col-md-4 col-lg-3 col-xl-3 text-center" href="#">
                            <a href="{{ route('admin.house', ['id' => $character->id]) }}" style="text-decoration: none; color: inherit;">
                                <div>
                        ...
                        <!-- Businesses -->
                        <div class="col-xs-12 col-md-4 col-lg-3 col-xl-3 text-center" href="#">
                            <a href="{{ route('admin.business', ['id' => $character->id]) }}" style="text-decoration: none; color: inherit;">
                                <div>
                        ...
                        <!-- Vehicles -->
                        <div class="col-xs-12 col-md-4 col-lg-3 col-xl-3 text-center" href="#">
                            <a href="{{ route('admin.vehicle', ['id' => $character->id]) }}" style="text-decoration: none; color: inherit;">
                                <div>
